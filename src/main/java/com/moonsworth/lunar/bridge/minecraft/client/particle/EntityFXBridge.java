...
default void bridge$renderParticle(WorldRendererBridge worldRendererBridge, EntityBridge entityBridge, float f, float f2, float f3, float f4, float f5, float f6) {
    }
}
