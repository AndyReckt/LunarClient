...
public class WSPacketChat extends AbstractWebSocketPacket {
    public String IlllIIIIIIlllIlIIlllIlIIl;

    public WSPacketChat() {
    }

    public WSPacketChat(final String illlIIIIIIlllIlIIlllIlIIl) {
    ...
    public void lIllIlIIIlIIIIIIIlllIlIll(final PacketBufferBridge packetBufferBridge) {
        this.IlllIIIIIIlllIlIIlllIlIIl = packetBufferBridge.bridge$readStringFromBuffer(512);
    }
