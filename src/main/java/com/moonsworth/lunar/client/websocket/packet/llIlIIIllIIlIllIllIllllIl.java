...
public class llIlIIIllIIlIllIllIllllIl extends AbstractWebSocketPacket {
    ...
    public llIlIIIllIIlIllIllIllllIl() {
    }

    public llIlIIIllIIlIllIllIllllIl(final List<UUID> illlIIIIIIlllIlIIlllIlIIl) {
