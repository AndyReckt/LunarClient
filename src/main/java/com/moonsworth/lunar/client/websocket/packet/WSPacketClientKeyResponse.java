...
public class WSPacketClientKeyResponse extends AbstractWebSocketPacket {
    ...
    public void lIllIlIIIlIIIIIIIlllIlIll(final PacketBufferBridge packetBufferBridge) {
        this.IlllIIIIIIlllIlIIlllIlIIl = this.readKey(packetBufferBridge);
    }
    ...
    public byte[] lIlIlIlIlIIlIIlIIllIIIIIl() {
        return this.IlllIIIIIIlllIlIIlllIlIIl;
    }

    public WSPacketClientKeyResponse(final byte[] illlIIIIIIlllIlIIlllIlIIl) {
