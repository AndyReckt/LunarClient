...
public class llllIIlIIlIIlIIllIIlIIllI extends AbstractWebSocketPacket {
    public String IlllIIIIIIlllIlIIlllIlIIl;

    public llllIIlIIlIIlIIllIIlIIllI(final String illlIIIIIIlllIlIIlllIlIIl) {
    ...
    public llllIIlIIlIIlIIllIIlIIllI() {
    }
}
