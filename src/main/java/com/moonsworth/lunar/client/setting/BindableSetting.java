...
public class BindableSetting extends AbstractFeatureSetting<String> {
    ...
    public static final HashBiMap<BindableSetting, KeyBindingBridge> lIlIlIlIlIIlIIlIIllIIIIIl = HashBiMap.create();
    ...
    public void lIlIlIlIlIIlIIlIIllIIIIIl(String string) {
        try {
            ...
            KeyBindingBridge keyBindingBridge = lIlIlIlIlIIlIIlIIllIIIIIl.get(this);
            if (keyBindingBridge != null) {
                keyBindingBridge.bridge$setKey(keyType);
            } else {
                KeyBindingBridge keyBindingBridge2 = Bridge.getInstance().initKeyBinding(this.f_(), Bridge.llIIlIlIIIllIlIlIlIIlIIll().lIllIlIIIlIIIIIIIlllIlIll(keyType), "Lunar Client");
    ...
    public void read(JsonObject jsonObject) {
        String string = !jsonObject.has(this.lIIlIlllIlIlIIIlllIIlIIII()) || jsonObject.get(this.lIIlIlllIlIlIIIlllIIlIIII()).isJsonNull() ? this.IIlIllIlllllllIIlIIIllIIl() : jsonObject.get(this.lIIlIlllIlIlIIIlllIIlIIII()).getAsString();
        ...
        if (IlllIIIIIIlllIlIIlllIlIIl.contains(this.f_())) {
            ...
            KeyBindingBridge keyBindingBridge = Bridge.getInstance().initKeyBinding(this.f_(), Bridge.llIIlIlIIIllIlIlIlIIlIIll().lIllIlIIIlIIIIIIIlllIlIll(keyType), "Lunar Client");
    ...
    public void write(JsonObject jsonObject) {
        ...
        String string = this.IllIllIIIllIIIlIlIlIIIIll().toUpperCase();
    ...
    public boolean IlllIIIIIIlllIlIIlllIlIIl() {
        KeyType keyType = KeyType.valueOf(this.llIlllIIIllllIIlllIllIIIl().toUpperCase());
    ...
    @Override
    public KeyType g_() {
        return KeyType.valueOf(this.IllIllIIIllIIIlIlIlIIIIll().toUpperCase());
    }
}
