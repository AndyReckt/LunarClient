    ...
    public void lIlIlIlIlIIlIIlIIllIIIIIl(float f, float f2, float f3, int n, int n2) {
        ...
        if (this.lIlIlIlIlIIlIIlIIllIIIIIl == 100010) {
            ...
            for (int i = 0; i < n; ++i) {
                ...
                float f12 = f;
                for (int j = 0; j <= n2; ++j) {
                    GL11.glVertex3f((float)(f9 * f12), (float)(f10 * f12), (float)f11);
                    f11 += f7;
                    f12 += f6;
                }
            }
                ...
                for (int i = 0; i < n2; ++i) {
                    ...
                    for (int j = 0; j <= n; ++j) {
                        ...
                        if (f4 == 1.0f) {
                            ...
                            GL11.glVertex3f((float)(f20 * f17), (float)(f19 * f17), (float)f16);
                            this.lIlIlIlIlIIlIIlIIllIIIIIl(f20 * f4, f19 * f4, f8 * f4);
                            this.lIlIlIlIlIIlIIlIIllIIIIIl(f18, f15 + f14);
                            GL11.glVertex3f((float)(f20 * (f17 + f6)), (float)(f19 * (f17 + f6)), (float)(f16 + f7));
                        } else {
                            this.lIlIlIlIlIIlIIlIIllIIIIIl(f20 * f4, f19 * f4, f8 * f4);
                            this.lIlIlIlIlIIlIIlIIllIIIIIl(f18, f15);
                            GL11.glVertex3f((float)(f20 * f17), (float)(f19 * f17), (float)f16);
            ...
            if (this.lIlIlIlIlIIlIIlIIllIIIIIl == 100011) {
                ...
                for (int i = 0; i <= n2; ++i) {
                    ...
                    for (n3 = 0; n3 < n; ++n3) {
                        ...
                        GL11.glVertex3f((float)(f22 * f24), (float)(f21 * f24), (float)f23);
                    }
                    GL11.glEnd();
                    f23 += f7;
                    f24 += f6;
                ...
                for (n3 = 0; n3 < n; ++n3) {
                    ...
                    f21 = this.lIlIlIlIlIIlIIlIIllIIIIIl((float)n3 * f5);
                    this.lIlIlIlIlIIlIIlIIllIIIIIl(f22 * f4, f21 * f4, f8 * f4);
                    GL11.glVertex3f((float)(f22 * f), (float)(f21 * f), (float)0.0f);
                }
                GL11.glEnd();
                GL11.glBegin((int)2);
                for (n3 = 0; n3 < n; ++n3) {
                    ...
                    f21 = this.lIlIlIlIlIIlIIlIIllIIIIIl((float)n3 * f5);
                    this.lIlIlIlIlIIlIIlIIllIIIIIl(f22 * f4, f21 * f4, f8 * f4);
                    GL11.glVertex3f((float)(f22 * f2), (float)(f21 * f2), (float)f3);
                }
                GL11.glEnd();
            }
            GL11.glBegin((int)1);
