...
public class SkyBlockAddonsManaTextChild extends AbstractFeatureContainerChild {
    public ColorSetting lllIIIIIlllIIlIllIIlIIIlI;
    public BooleanSetting lIlIIIIIIlIIIllllIllIIlII;

    public SkyBlockAddonsManaTextChild(ConfigurableFeature var1) {
    ...
    public void lIllIlIIIlIIIIIIIlllIlIll(float var1, float var2) {
        String var3 = Ref.getLC().lllllIllIllIllllIlIllllII().lIIIlllIIIIllllIlIIIlIIll().IIIllIlIllIIllIlIlllIllIl().getMana() + "/" + Ref.getLC().lllllIllIllIllllIlIllllII().lIIIlllIIIIllllIlIIIlIIll().IIIllIlIllIIllIlIlllIllIl().getMaxMana();
    ...
    public List IlIlIlllllIlIIlIlIlllIlIl() {
        return ImmutableList.of(this.lllIIIIIlllIIlIllIIlIIIlI = new ColorSetting("healthbarColor", -11184641), this.lIlIIIIIIlIIIllllIllIIlII = new BooleanSetting("textShadow", true));
    }
    ...
    public FeatureDetails initDetails() {
        return new FeatureDetails("skyBlockAddonsManaTextChild", ImmutableList.of());
    }
}
