...
public class SkyBlockAddonsDefenseTextChild extends AbstractFeatureContainerChild {
    public ColorSetting lllIIIIIlllIIlIllIIlIIIlI;
    public BooleanSetting lIlIIIIIIlIIIllllIllIIlII;

    public SkyBlockAddonsDefenseTextChild(ConfigurableFeature var1) {
    ...
    public FeatureDetails initDetails() {
        return new FeatureDetails("skyBlockAddonsDefenseTextChild", ImmutableList.of());
    }
}
