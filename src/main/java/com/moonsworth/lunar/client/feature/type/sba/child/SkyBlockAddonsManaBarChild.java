...
public class SkyBlockAddonsManaBarChild extends AbstractFeatureContainerChild {
    ...
    public SkyBlockAddonsManaBarChild(ConfigurableFeature var1) {
    ...
    public void lIllllIllIIlIIlIIIlIIIlII() {
        this.lIlIlIlIlIIlIIlIIllIIIIIl(40.0F, -40.0F);
    }
    ...
    public void lIllIlIIIlIIIIIIIlllIlIll(float var1, float var2) {
        ...
        float var5 = 0.0F;
        double var6 = 10.0D;
        float var8 = (float)Ref.getLC().lllllIllIllIllllIlIllllII().lIIIlllIIIIllllIlIIIlIIll().IIIllIlIllIIllIlIlllIllIl().getMana() / (float)Math.max(1, Ref.getLC().lllllIllIllIllllIlIllllII().lIIIlllIIIIllllIlIIIlIIll().IIIllIlIllIIllIlIlllIllIl().getMaxMana());
        ...
        if (Ref.getLC().lllllIllIllIllllIlIllllII().lIIIlllIIIIllllIlIIIlIIll().IIIllIlIllIIllIlIlllIllIl().getMana() + 1 < Ref.getLC().lllllIllIllIllllIlIllllII().lIIIlllIIIIllllIlIIIlIIll().IIIllIlIllIIllIlIlllIllIl().getMaxMana()) {
            Bridge.llIIIIIIIllIIllIlIllIIIIl().bridge$color(0.25F, 0.25F, 0.25F);
        }
    ...
    public List IlIlIlllllIlIIlIlIlllIlIl() {
        return ImmutableList.of(this.lIlIIIIIIlIIIllllIllIIlII = new ColorSetting("manabarColor", -11184641));
    }
    ...
    public FeatureDetails initDetails() {
        return new FeatureDetails("skyBlockAddonsManaBarChild", ImmutableList.of());
    }
}
