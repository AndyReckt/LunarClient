...
public class WaypointsMod extends ConfigurableFeature {
    public final ResourceLocationBridge llllIIlIIlIIlIIllIIlIIllI = Bridge.getInstance().initResourceLocation("textures/entity/beacon_beam.png");
    ...
    public WaypointsMod() {
        ...
        this.llIIlIlIIIllIlIlIlIIlIIll.IlllIIIIIIlllIlIIlllIlIIl(true).lIlIlIlIlIIlIIlIIllIIIIIl(true).lIlIlIlIlIIlIIlIIllIIIIIl(bl -> Ref.getMinecraft().bridge$displayScreen(Bridge.getInstance().initCustomScreen(new WaypointUIScreen(Ref.getMinecraft().bridge$getCurrentScreen()))));
    }
    ...
    public void onRenderWorldPass(RenderWorldPassEvent renderWorldPassEvent) {
        ...
        for (Waypoint waypoint : LunarClient.getInstance().llIllIlIllIlllIllIIIIllII().llIlllIIIllllIIlllIllIIIl()) {
            if (!waypoint.isVisible() || !waypoint.lIlIlIlIlIIlIIlIIllIIIIIl()) continue;
            double d = this.lIlIlIlIlIIlIIlIIllIIIIIl(waypoint, this.mc.bridge$getRenderViewEntity());
            double d2 = (double)((float)this.mc.bridge$getGameSettings().bridge$getRenderDistance() * 16.0f) * 0.75;
            if (this.IlIlIlllllIlIIlIlIlllIlIl.llIlllIIIllllIIlllIllIIIl().booleanValue()) {
    ...
    public void lIlIlIlIlIIlIIlIIllIIIIIl(Waypoint waypoint, float f, double d, double d2) {
        ...
        double d6 = (double)((float)waypoint.getLocation().bridge$xCoord()) - d3;
        double d7 = (double)((float)waypoint.getLocation().bridge$zCoord()) - d5;
        ...
        float f2 = 0.75f;
        float f3 = 0.0f;
        float f4 = (float) MathHelperUtil.lIlIlIlIlIIlIIlIIllIIIIIl(Ref.getPlayer().bridge$getPosY() + 50.0, waypoint.getLocation().bridge$yCoord(), 256.0);
        int n = 20;
        int n2 = 1;
        float f5 = 1.0f * ((float)Math.max(0.0, Math.min(60.0, this.lIlIlIlIlIIlIIlIIllIIIIIl(waypoint, Ref.getPlayer()) - 4.0)) / 60.0f);
        float f6 = 0.6f * f5;
        int n3 = waypoint.getColor().lIlIlIlIlIIlIIlIIllIIIIIl(0.0f);
        ...
        Bridge.llIIIIIIIllIIllIlIllIIIIl().bridge$translate(0.0f, 0.0f, (float)(waypoint.getLocation().bridge$yCoord() + (double)0.001f));
    ...
    public void lIlIlIlIlIIlIIlIIllIIIIIl(Waypoint waypoint, double d, double d2) {
        ...
        double d3 = waypoint.getLocation().bridge$xCoord() - renderManagerBridge.getRenderPosX();
        double d4 = 2.0 + waypoint.getLocation().bridge$yCoord() - renderManagerBridge.getRenderPosY();
        double d5 = waypoint.getLocation().bridge$zCoord() - renderManagerBridge.getRenderPosZ();
        String string = waypoint.getName() + " [" + (int)d + "m]";
        if (d > d2) {
            d3 = d3 / d * d2;
            d4 = d4 / d * d2;
            d5 = d5 / d * d2;
        ...
        float f2 = this.IlllllIlIIIlIIlIIllIIlIll.llIlllIIIllllIIlllIllIIIl().floatValue();
        float f3 = (float)(-n) - f2;
        float f4 = -f2;
        float f5 = (float)(n * 2) + f2 * 2.0f;
        float f6 = 8.0f + f2 * 2.0f;
        float f7 = 1.0f * ((float)Math.max(0.0, Math.min(10.0, this.lIlIlIlIlIIlIIlIIllIIIIIl(waypoint, Ref.getPlayer()) - 4.0)) / 10.0f);
        AbstractUIScreen.lIllIlIIIlIIIIIIIlllIlIll(f3, f4, f5, f6, (int)(0.4f * f7 * 255.0f) << 24);
        if (this.llIIIIIIIllIIllIlIllIIIIl.llIlllIIIllllIIlllIllIIIl().booleanValue()) {
            int n2 = (int)(f7 * 255.0f) << 24 | waypoint.getColor().lIlIlIlIlIIlIIlIIllIIIIIl(0.0f) & 0xFFFFFF;
            float f8 = 0.5f;
        ...
        Bridge.llIIIIIIIllIIllIlIllIIIIl().bridge$enableBlend();
        fontRendererBridge.bridge$drawString(string, -n, 0.0f, (int)Math.max(4.0f, f7 * 255.0f) << 24 | 0xFFFFFF, this.lIIIllIllIIllIlllIlIIlllI.llIlllIIIllllIIlllIllIIIl());
        Bridge.llIIIIIIIllIIllIlIllIIIIl().bridge$disableBlend();
        Bridge.llIIIIIIIllIIllIlIllIIIIl().bridge$depthMask(true);
    ...
    public double lIlIlIlIlIIlIIlIIllIIIIIl(Waypoint waypoint, EntityBridge entityBridge) {
        double d = waypoint.getLocation().bridge$xCoord() - entityBridge.bridge$getPosX();
        double d2 = waypoint.getLocation().bridge$yCoord() - entityBridge.bridge$getPosY();
        double d3 = waypoint.getLocation().bridge$zCoord() - entityBridge.bridge$getPosZ();
    ...
    public List IlIlIlllllIlIIlIlIlllIlIl() {
        ...
        this.llIIlIlIIIllIlIlIlIIlIIll = new BindableSetting(this, "add_waypoint", KeyType.KEY_N);
    ...
    public FeatureDetails initDetails() {
        return new FeatureDetails("waypoints", ImmutableList.of(ModuleCategory.ALL));
    }
