...
import com.moonsworth.lunar.client.cosmetic.au.lIlIlIlIlIIlIIlIIllIIIIIl;
...
public class CosmeticManagerLayer implements CustomLayer {
    public final CosmeticManager manager;

    public CosmeticManagerLayer(CosmeticManager cosmeticManager) {
        this.manager = cosmeticManager;
    }
    ...
    public void lIlIlIlIlIIlIIlIIllIIIIIl(AbstractClientPlayerBridge abstractClientPlayerBridge, ModelPlayerBridge modelPlayerBridge, float f, float f2, float f3, float f4, float f5, float f6, float f7) {
        ...
        List<RenderableCosmeticType> list = this.manager.lIlIlIlIlIIlIIlIIllIIIIIl(abstractClientPlayerBridge.bridge$getUniqueID(), RenderableCosmeticType.class);
        for (RenderableCosmeticType renderableCosmeticType : list) {
            AbstractCosmetic abstractCosmetic;
            if (renderableCosmeticType == null || !renderableCosmeticType.lIllIlIIIlIIIIIIIlllIlIll().lIIIllIllIIllIlllIlIIlllI().llIlllIIIllllIIlllIllIIIl().booleanValue() || !renderableCosmeticType.llIIIIIIIllIIllIlIllIIIIl() || (abstractCosmetic = this.manager.IlllIIIIIIlllIlIIlllIlIIl(renderableCosmeticType.llllIIlIIlIIlIIllIIlIIllI())) == null || abstractCosmetic.llIIlIlIIIllIlIlIlIIlIIll().lIlIlIlIlIIlIIlIIllIIIIIl() && abstractClientPlayerBridge.bridge$getArmor(abstractCosmetic.llIIlIlIIIllIlIlIlIIlIIll().IlllIIIIIIlllIlIIlllIlIIl()) != null && !abstractCosmetic.llllIIlIIlIIlIIllIIlIIllI()) continue;
            if (bl) {
            ...
            lIlIlIlIlIIlIIlIIllIIIIIl.lIlIlIlIlIIlIIlIIllIIIIIl(abstractClientPlayerBridge, modelPlayerBridge, renderableCosmeticType, abstractCosmetic, f, f2, f5, f6, f7, f4, f3, false, bl);
        }
    }
    ...
    public void lIlIlIlIlIIlIIlIIllIIIIIl(AbstractClientPlayerBridge abstractClientPlayerBridge, ModelPlayerBridge modelPlayerBridge, int n, int n2, lIllIlIIIlIIIIIIIlllIlIll lIllIlIIIlIIIIIIIlllIlIll2, MatrixStackBridge matrixStackBridge, float f) {
        ...
        if (bl && cosmetic.animator != null) {
            object = cosmetic.animator.animation.meshes.get(0).armature;
            cosmetic.animator.setupMatrix(object.bones.get("low_body"), matrixStackBridge);
        }
        if ((renderableCosmeticType = this.manager.lIlIlIlIlIIlIIlIIllIIIIIl(abstractClientPlayerBridge.bridge$getUniqueID(), RenderableCosmeticType.class).get(n2)) != null && renderableCosmeticType.lIllIlIIIlIIIIIIIlllIlIll().lIIIllIllIIllIlllIlIIlllI().llIlllIIIllllIIlllIllIIIl().booleanValue() && renderableCosmeticType.llIIIIIIIllIIllIlIllIIIIl()) {
            AbstractCosmetic abstractCosmetic = this.manager.IlllIIIIIIlllIlIIlllIlIIl(renderableCosmeticType.llllIIlIIlIIlIIllIIlIIllI());
            ...
            lIlIlIlIlIIlIIlIIllIIIIIl.lIlIlIlIlIIlIIlIIllIIIIIl(abstractClientPlayerBridge, lIllIlIIIlIIIIIIIlllIlIll2, matrixStackBridge, n, modelPlayerBridge, renderableCosmeticType, abstractCosmetic, 0.0f, f, false, bl);
        }
    }

    @Override
    public Optional lIlIlIlIlIIlIIlIIllIIIIIl(AbstractClientPlayerBridge abstractClientPlayerBridge, int n) {
        List list = this.manager.lIlIlIlIlIIlIIlIIllIIIIIl(abstractClientPlayerBridge.bridge$getUniqueID(), RenderableCosmeticType.class);
    ...
    public int lIlIlIlIlIIlIIlIIllIIIIIl(AbstractClientPlayerBridge abstractClientPlayerBridge) {
        return this.manager.lIlIlIlIlIIlIIlIIllIIIIIl(abstractClientPlayerBridge.bridge$getUniqueID(), RenderableCosmeticType.class).size();
    }
}
