...
public class Model {
    ...
    public void lIlIlIlIlIIlIIlIIllIIIIIl(int n, int n2) {
        ...
        GL15.glBufferData((int)34962, (FloatBuffer)this.llIlllIIIllllIIlllIllIIIl, (int)35048);
    ...
    public void lIlIlIlIlIIlIIlIIllIIIIIl() {
        ...
        if (this.lIlIlIlIlIIlIIlIIllIIIIIl != null) {
            Ref.lIlIlIlIlIIlIIlIIllIIIIIl().bridge$getTextureManager().bridge$bindTexture(this.lIlIlIlIlIIlIIlIIllIIIIIl);
...
//        openGlHelperBridge.bridge$disableLightMap();
    ...
    public void llllIIlIIlIIlIIllIIlIIllI() {
        this.IlllIIIIIIlllIlIIlllIlIIl = BufferUtils.createFloatBuffer((int)this.llIIIlllIIlllIllllIlIllIl.posData.length);
        this.IlllIIIIIIlllIlIIlllIlIIl.put(this.llIIIlllIIlllIllllIlIllIl.posData).flip();
        this.lIllIlIIIlIIIIIIIlllIlIll = BufferUtils.createFloatBuffer((int)this.llIIIlllIIlllIllllIlIllIl.normData.length);
        this.lIllIlIIIlIIIIIIIlllIlIll.put(this.llIIIlllIIlllIllllIlIllIl.normData).flip();
        this.llIlllIIIllllIIlllIllIIIl = BufferUtils.createFloatBuffer((int)this.llIIIlllIIlllIllllIlIllIl.texData.length);
        this.llIlllIIIllllIIlllIllIIIl.put(this.llIIIlllIIlllIllllIlIllIl.texData).flip();
        this.llllIIlIIlIIlIIllIIlIIllI = BufferUtils.createIntBuffer((int)this.llIIIlllIIlllIllllIlIllIl.indexData.length);
        ...
        GL15.glBindBuffer((int)34962, (int)this.IlIlIlllllIlIIlIlIlllIlIl);
        GL15.glBufferData((int)34962, (FloatBuffer)this.IlllIIIIIIlllIlIIlllIlIIl, (int)35048);
        this.llIIIIIIIllIIllIlIllIIIIl = GL15.glGenBuffers();
        GL15.glBindBuffer((int)34962, (int)this.llIIIIIIIllIIllIlIllIIIIl);
        GL15.glBufferData((int)34962, (FloatBuffer)this.lIllIlIIIlIIIIIIIlllIlIll, (int)35044);
        this.lIIIllIllIIllIlllIlIIlllI = GL15.glGenBuffers();
        GL15.glBindBuffer((int)34962, (int)this.lIIIllIllIIllIlllIlIIlllI);
        GL15.glBufferData((int)34962, (FloatBuffer)this.llIlllIIIllllIIlllIllIIIl, (int)35044);
        this.IlllllIlIIIlIIlIIllIIlIll = GL15.glGenBuffers();
        GL15.glBindBuffer((int)34963, (int)this.IlllllIlIIIlIIlIIllIIlIll);
        GL15.glBufferData((int)34963, (IntBuffer)this.llllIIlIIlIIlIIllIIlIIllI, (int)35044);
        GL15.glBindBuffer((int)34962, (int)0);
        GL15.glBindBuffer((int)34963, (int)0);
    }
    ...
    public void lIllIlIIIlIIIIIIIlllIlIll() {
        GL15.glDeleteBuffers((int)this.IlIlIlllllIlIIlIlIlllIlIl);
        GL15.glDeleteBuffers((int)this.llIIIIIIIllIIllIlIllIIIIl);
        GL15.glDeleteBuffers((int)this.lIIIllIllIIllIlllIlIIlllI);
        GL15.glDeleteBuffers((int)this.IlllllIlIIIlIIlIIllIIlIll);
    ...
    public void llIlllIIIllllIIlllIllIIIl() {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            for (int j = 0; j < 4; ++j) {
                ...
                vector4f.mul(f);
                vector4f2.add((Vector4fc)vector4f);
                vector3f.set(fArray3[i * 3], fArray3[i * 3 + 1], fArray3[i * 3 + 2]);
                vector3f.mul(f);
                vector3f2.add((Vector3fc)vector3f);
                ++n2;
            }
            if (n2 == 0) {
    ...
    public void IlllIIIIIIlllIlIIlllIlIIl(float[] fArray) {
        ...
        GL15.glBindBuffer((int)34962, (int)this.llIIIIIIIllIIllIlIllIIIIl);
        GL15.glBufferData((int)34962, (FloatBuffer)this.lIllIlIIIlIIIIIIIlllIlIll, (int)35048);
    }
