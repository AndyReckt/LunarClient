...
public class RenderableCosmeticType extends Cosmetic {
    public RenderableCosmeticType(long l, String string, float f, String string2, CosmeticType cosmeticType, boolean bl) {
