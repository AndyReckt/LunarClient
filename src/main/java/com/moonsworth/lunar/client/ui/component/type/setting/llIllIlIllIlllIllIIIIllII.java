...
public class llIllIlIllIlllIllIIIIllII
extends UIComponent {
    ...
    public llIllIlIllIlllIllIIIIllII(UIComponent uIComponent, ResourceLocationBridge resourceLocationBridge) {
        super(uIComponent);
        this.lIlIlIlIlIIlIIlIIllIIIIIl = resourceLocationBridge;
    }

    public llIllIlIllIlllIllIIIIllII(UIComponent uIComponent, String string, ResourceLocationBridge resourceLocationBridge) {
        super(uIComponent);
    ...
    public void lIlIlIlIlIIlIIlIIllIIIIIl(float f, float f2, boolean bl) {
        ...
        if (this.lIllIlIIIlIIIIIIIlllIlIll) {
            n = this.IIlIllIlIIllIIlIlIllllllI.lIlIlIlIlIIlIIlIIllIIIIIl(this.IlllIIIIIIlllIlIIlllIlIIl || bl && this.IlllIIIIIIlllIlIIlllIlIIl(f, f2));
            int n2 = this.lIIIlllIIIIllllIlIIIlIIll.lIlIlIlIlIIlIIlIIllIIIIIl(this.IlllIIIIIIlllIlIIlllIlIIl || bl && this.IlllIIIIIIlllIlIIlllIlIIl(f, f2));
            AbstractUIScreen.lIlIlIlIlIIlIIlIIllIIIIIl(this.x, this.y, this.width, this.height, 4.0f, n, 0x20FFFFFF, n2);
        }
        if (this.lllllIllIlIIlIIlIIIlllIlI != null && this.IlllIIIIIIlllIlIIlllIlIIl(f, f2) && bl) {
            Anchor anchor = MovementUI.lIlIlIlIlIIlIIlIIllIIIIIl(f, f2);
            float f6 = FontRegistry.lIlIIIIIIlIIIllllIllIIlII().IlllIIIIIIlllIlIIlllIlIIl(this.get(this.lllllIllIlIIlIIlIIIlllIlI, new Object[0]).toUpperCase()) + 8;
            f5 = anchor.lIllIlIIIlIIIIIIIlllIlIll() == Position.TOP ? this.y + this.height + 8.0f : this.y - 8.0f - (float)(FontRegistry.IlIlIlllllIlIIlIlIlllIlIl().lIlIlIlIlIIlIIlIIllIIIIIl() * 2);
            f4 = this.x + this.width / 2.0f - f6 / 2.0f;
            AbstractUIScreen.IlllllIlIIIlIIlIIllIIlIll(f4, f5, f6, FontRegistry.lIIIllIllIIllIlllIlIIlllI().lIlIlIlIlIIlIIlIIllIIIIIl() * 2 + 5, 5.0f, Integer.MIN_VALUE);
            FontRegistry.lIlIIIIIIlIIIllllIllIIlII().lIlIlIlIlIIlIIlIIllIIIIIl(this.get(this.lllllIllIlIIlIIlIIIlllIlI, new Object[0]).toUpperCase(), f4 + 4.0f, f5 + 2.0f, Integer.MAX_VALUE);
        }
        n = this.IllIIIlllIIIlIlllIlIIlIII.lIlIlIlIlIIlIIlIIllIIIIIl(this.IlllIIIIIIlllIlIIlllIlIIl(f, f2) && bl);
